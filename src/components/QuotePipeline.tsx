    ...
    <div className='p-4 lg:p-8 space-y-6 lg:space-y-8 max-w-7xl mx-auto overflow-y-auto no-scrollbar'>
      ...
      <div className='grid grid-cols-2 lg:grid-cols-4 gap-4'>
        <div className='bg-surface-container-low p-4 rounded-2xl border border-white/5'>
          ...
          <p className='text-2xl font-bold text-white'>{formatCurrency(totalValue, config.localization.currency, config.localization.showAllCurrencies)}</p>
        </div>
        <div className='bg-surface-container-low p-4 rounded-2xl border border-white/5'>
          <div className='flex items-center gap-2 text-slate-500 mb-2'>
          ...
          <p className='text-2xl font-bold text-emerald-400'>{formatCurrency(acceptedValue, config.localization.currency, config.localization.showAllCurrencies)}</p>
        </div>
        <div className='bg-surface-container-low p-4 rounded-2xl border border-white/5'>
          <div className='flex items-center gap-2 text-slate-500 mb-2'>
            ...
            <tbody>
              {filteredQuotes.map((quote) => (
                <tr key={quote.id} className='border-b border-white/5 hover:bg-white/5 transition-colors'>
                  ...
                  <td className='p-4 text-white'>{formatCurrency(quote.totalPrice || 0, config.localization.currency, config.localization.showAllCurrencies)}</td>
                  <td className='p-4 text-white font-bold'>{formatCurrency(quote.grandTotal || 0, config.localization.currency, config.localization.showAllCurrencies)}</td>
